...
(function (factory) {
    ...
    $.fn.fileinputLocales['th'] = {
        ...
        pauseLabel: 'หยุดชั่วคาว',
        pauseTitle: 'หยุดไฟล์ที่กำลังอัพโหลดชั่วคราว',
        uploadLabel: 'อัพโหลด',
        ...
        msgPaused: 'Paused',
        msgCancelled: 'ยกเลิก',
        msgPlaceholder: 'เลือก{files}หลักฐาน  ...',
        ...
        dropZoneTitle: 'ลากไฟล์ตรงนี้ &hellip;',
        dropZoneClickTitle: '<br>(หรือ คลิ๊กเพื่อเลือก{files})',
        fileActionSettings: {
            removeTitle: 'ลบไฟล์',
